    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('img/logo.png') }}"
                            width="50" alt="Logo de la página web" class="img-fluid">
                    </a>
                </div>
                ...
                {{-- Listas --}}
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('ListaAdminAutomotor')" :active="request()->routeIs('ListaAdminAutomotor')">
                        {{ __('Automotores') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('ListaAdminTitular')" :active="request()->routeIs('ListaAdminTitular')">
                        {{ __('Titulares') }}
                    </x-nav-link>
                </div>

                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('ListaAdminInfraccion')" :active="request()->routeIs('ListaAdminInfraccion')">
                        {{ __('Infracciones') }}
                    </x-nav-link>
                </div>
            </div>
